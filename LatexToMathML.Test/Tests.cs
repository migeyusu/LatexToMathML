...
public class Tests
{
    ...
    public void ConvertXSquaredReturnXSquaredInMML()
    {
        ...
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""x^2"" display=""inline"" class=""normalsize"">
...
<mn>2</mn>
    ...
    public void ConvertFracXYPlus2ReturnsFracXYPlus2InMML()
    {
        ...
        latex2MathMLConverter.Convert(latexToConvert);
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""\frac{x}{y}+2"" display=""inline"" class=""normalsize"">
<mstyle displaystyle=""true"" /><mrow>
<mfrac>
<mrow>
<mi>x</mi>
...
<mn>2</mn>
    ...
    public void ConvertOperatorsSinCosReturnsSinCos()
    {
        ...
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""\cos (2\theta) = \cos^2 \theta - \sin^2 \theta"" display=""inline"" class=""normalsize"">
<mstyle displaystyle=""true"" /><mrow>
<mi>cos</mi>
<mfenced>
<mrow>
...
<mi>&#x3B8;<!-- &theta; --></mi></mrow>
    ...
    public void ConvertSymbolsForAllInQuadExistsLeqEpsilonLeGeqGeReturnsCorrectMML()
    {
        ...
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""\forall x \in X, \quad \exists y \leq \epsilon \le \geq \ge"" display=""inline"" class=""normalsize"">
<mstyle displaystyle=""true"" /><mrow>
<mo>&#x2200;<!-- &forall; --></mo>
<mi>x</mi>
<mo>&#x2208;<!-- &isin; --></mo>
...
<mo>&#8805; <!-- ge --> </mo> 
    ...
    public void ConvertSymbolsGreekLettersReturnsCorrectMML()
    {
        String latexExpression =
            @"$A, \alpha, B, \beta, \Gamma, \gamma, \Delta, \delta, E, \epsilon, \varepsilon, Z, \zeta, H, \eta, \Theta, \theta, \vartheta, I, \iota, K, \kappa, \varkappa, \Lambda, \lambda, M, \mu, N, \nu, \Xi, \xi, O, o, \Pi, \pi, \varpi, P, \rho, \varrho, \Sigma, \sigma, \varsigma, T, \tau, \Upsilon, \upsilon, \Phi, \phi, \varphi, X, \chi, \Psi, \psi, \Omega, \omega$";
        String latexToConvert = begin + latexExpression + end;
        latex2MathMLConverter = new LatexMathToMathMLConverter();
        ...
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""A, \alpha, B, \beta, \Gamma, \gamma, \Delta, \delta, E, \epsilon, \varepsilon, Z, \zeta, H, \eta, \Theta, \theta, \vartheta, I, \iota, K, \kappa, \varkappa, \Lambda, \lambda, M, \mu, N, \nu, \Xi, \xi, O, o, \Pi, \pi, \varpi, P, \rho, \varrho, \Sigma, \sigma, \varsigma, T, \tau, \Upsilon, \upsilon, \Phi, \phi, \varphi, X, \chi, \Psi, \psi, \Omega, \omega"" display=""inline"" class=""normalsize"">
<mstyle displaystyle=""true"" /><mrow>
<mi>A</mi>
<mo>,</mo>
<mi>&#x3B1;<!-- &alpha; --></mi><mo>,</mo>
...
<mi>&#x3C9;<!-- &omega; --></mi></mrow>
    ...
    public void ConvertOperatorsWhitespacesReturnsMMLWithCorrectSpacing()
    {
        ...
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""A,\qquad B, \quad C, \; D, \: E, \, F, \! G "" display=""inline"" class=""normalsize"">
<mstyle displaystyle=""true"" /><mrow>
<mi>A</mi>
<mo>,</mo>
...
<mo>&#x2222;<!-- &angsph; --></mo>
    ...
    public void ConvertOperatorsDotsReturnsCorrectMML()
    {
        ...
        String expected =
            @"<math xmlns=""http://www.w3.org/1998/Math/MathML"" alttext=""\dots \dotsm \vdots \ddots"" display=""inline"" class=""normalsize"">
<mstyle displaystyle=""true"" /><mrow>
<mo>&hellip;</mo>
<mo>&ctdot;</mo>
<mo>&dtdot;</mo>
<mo>&vellip;</mo>
    ...
    {
        String latexExpression =
            @"$\pm \mp \times \div \ast \star \dagger \ddagger \cap \cup \uplus \sqcap \sqcup \vee \wedge \cdot \diamond \bigtriangleup \bigtriangledown \triangleleft \triangledown \bigcirc \bullet \wr \oplus \ominus \otimes \oslash \odot \circ \setminus \amalg$";
        String latexToConvert = begin + latexExpression + end;
        latex2MathMLConverter = new LatexMathToMathMLConverter();
